...
for (var i = 0; i < global.inventory_total_slots; i++) {
    ...
    // Scegli sprite slot in base allo stato (STESSA LOGICA TOOLBAR)
    ...
    if (!is_unlocked) {
        ...
        slot_alpha = 1;
    } else if (is_unlocked && i < 10 && variable_global_exists("selected_tool") && global.selected_tool == i) {
        // Se è nella prima riga E selezionato dalla toolbar, usa spr_slot_select
